...
public final class GraphUtils {
	 ...
	 * @param scheduler
	 */
	public static void triigerStartNode(Node<NodeCommand> startNode,GraphScheduler scheduler){
		GraphRunnable graphAction = new GraphRunnable(startNode, scheduler);
		submit(graphAction);
	}
	
	public static void triigerStartNode(Node<NodeCommand> startNode,Graph graph){
